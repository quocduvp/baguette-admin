        ...
        return (
            <AppHeaderDropdown direction="down">
                ...
                <DropdownMenu right style={{ right: 'auto' }}>
                    ...
                    {restaurants.map((res)=>{
                        return (
                            <DropdownItem key={res.id} onClick={this.changeRes.bind(this,res)}><i className={Number(restaurant_id) === Number(res.restaurant_id) ? 'fa fa-check-square-o' : 'fa fa-square-o'}></i> {res.restaurant.name}</DropdownItem>
                        )
                    })}
                </DropdownMenu>
            </AppHeaderDropdown>
